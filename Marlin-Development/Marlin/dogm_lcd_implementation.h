...
#define USE_SMALL_INFOFONT
  ...
  #define FONT_STATUSMENU_NAME u8g_font_6x10_kanji
  //u8g_font_6x9
#else
...
#define FONT_MENU_NAME u8g_font_6x10_kanji //MENU FONT
...
//      u8g.drawBitmapP(offx, offy, START_BMPBYTEWIDTH, START_BMPHEIGHT, start_bmp);
      switch(boot_display_mode){
        case 1:
          u8g.drawBitmapP(0, 0, START_BMPBYTEWIDTH, START_BMPHEIGHT, start_bmp1);
          break;
        case 2:
          u8g.drawBitmapP(0, 0, START_BMPBYTEWIDTH, START_BMPHEIGHT, start_bmp2);
          break;
        case 3:
          u8g.drawBitmapP(0, 0, START_BMPBYTEWIDTH, START_BMPHEIGHT, start_bmp3);
          break;
      }
...
//        u8g.drawStr(txt1X, u8g.getHeight() - DOG_CHAR_HEIGHT, STRING_SPLASH_LINE1);
        u8g.drawStr(90, 26, STRING_SPLASH_LINE1);
      #else
...
//  u8g.drawBitmapP(9,1,STATUS_SCREENBYTEWIDTH,STATUS_SCREENHEIGHT, (blink % 2) && fanSpeed ? status_screen0_bmp : status_screen1_bmp);
  u8g.drawBitmapP(9+25,1,STATUS_SCREENBYTEWIDTH,STATUS_SCREENHEIGHT, (blink % 2) && fanSpeed ? status_screen0_bmp : status_screen1_bmp);
 
// 
  lcd_setFont(FONT_MENU);
  u8g.setPrintPos(7,10);
  lcd_print("\xc9\xbd\xde\xd9"); //ノズル
  u8g.setPrintPos(7,20);
  lcd_print("\x80\x81\x82\x83"); //温度
  u8g.setPrintPos(78,10);
  lcd_print("\xcd\xde\xaf\xc4\xde"); //ベッド
...
//  for (int i=0; i<EXTRUDERS; i++) _draw_heater_status(6 + i * 25, i);
  for (int i=0; i<EXTRUDERS; i++) _draw_heater_status(31 + i * 25, i);

  // Heatbed
//  if (EXTRUDERS < 4) _draw_heater_status(81, -1);
  if (EXTRUDERS < 4) _draw_heater_status(81+25, -1);
