...
#define MSG_LCD_NOZZLE                      "Nozl"      //ノズル
#define MSG_LCD_TEMP                        "Temp"      //温度
#define MSG_LCD_BED                         "Bed"       //ベッド
#define MSG_LCD_BOOT_DISPLAY                "Boot Display Mode" //
#define MSG_LCD_SET_FILAMENT                "FILAMENT LOAD/UNLOAD"
#define MSG_LCD_LOAD_FILAMENT               "LOAD FILAMENT"
#define MSG_LCD_UNLOAD_FILAMENT             "UNLOAD FILAMENT"
#define MSG_NOZZLE_TEMP                     "NOZZLE TEMP."
