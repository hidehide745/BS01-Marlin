...
// BS01+改　テスト用ファーム
// MANUAL BED LEVELING(LCDコントローラよりメニュー選択、４点指示後にメモリ格納実行)
// M990 起動画面切り替え
// LAST UPDATE 2015.07.12　コメント追記
...
// 起動画面選択デフォルトの設定 M980コマンドにて切り替え、M500で設定保存
// 1:ロゴマーク
// 2:キャラクタ1
// 3:キャラクタ2
#define BOOT_DISPLAY 1
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 120 //125
    #define FRONT_PROBE_BED_POSITION 20
    #define BACK_PROBE_BED_POSITION 90 //125
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 25 //-25     // Probe on: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -13 // 13     // Probe on: -front +behind
...
// 原点復帰時の速度
#define HOMING_FEEDRATE {50*60, 50*60, 4*60, 0}  // set the homing speeds (mm/min)　標準リード
...
//最大送り速度
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)　標準リード
...
// See also language.h
#define LANGUAGE_INCLUDE GENERATE_LANGUAGE_INCLUDE(jp)　//日本語メニュー
//#define LANGUAGE_INCLUDE GENERATE_LANGUAGE_INCLUDE(en)　//英語メニュー
