...
SERIAL_ECHOPGM("\ncurrent_position[E_AXIS] :");SERIAL_ECHO(current_position[E_AXIS]);
SERIAL_ECHOPGM("\nmanual_feedrate[X_AXIS]/60 :");SERIAL_ECHO(manual_feedrate[X_AXIS]/60);
SERIAL_ECHOPGM("\nactive_extruder:");SERIAL_ECHO((float)active_extruder);  
*/
...
//  MENU_ITEM(submenu, MSG_VOLUMETRIC, lcd_control_volumetric_menu); // フィラメントメニュー
  MENU_ITEM_EDIT( int3 , MSG_LCD_BOOT_DISPLAY , &boot_display_mode , 1,3 ); // 起動画面選択
...
char *ftostr52(const float &x) {
  ...
  static void _lcd_level_bed() {
//SERIAL_ECHO_START;// test
//SERIAL_ECHOPGM("\n encoderPosition :");SERIAL_ECHO(encoderPosition);
...
//SERIAL_ECHOPGM("\n@current_position[Z_AXIS] :");SERIAL_ECHO(current_position[Z_AXIS]);
  ...
  static void _lcd_level_bed_homing() {
    if (lcdDrawUpdate) lcd_implementation_drawedit(PSTR("XYZ"), MSG_HOMING );
//SERIAL_ECHO_START;// test
//SERIAL_ECHOPGM("\n Homing:");
//SERIAL_ECHOPGM("\n axis_known_position[X_AXIS] :");SERIAL_ECHO(axis_known_position[X_AXIS]);
//SERIAL_ECHOPGM("\n axis_known_position[Y_AXIS] :");SERIAL_ECHO(axis_known_position[Y_AXIS]);
//SERIAL_ECHOPGM("\n axis_known_position[Z_AXIS] :");SERIAL_ECHO(axis_known_position[Z_AXIS]);
//SERIAL_ECHOPGM("\ncurrent_position[X_AXIS] :");SERIAL_ECHO(current_position[X_AXIS]);
//SERIAL_ECHOPGM("\ncurrent_position[Y_AXIS] :");SERIAL_ECHO(current_position[Y_AXIS]);
//SERIAL_ECHOPGM("\ncurrent_position[Z_AXIS] :");SERIAL_ECHO(current_position[Z_AXIS]);    
